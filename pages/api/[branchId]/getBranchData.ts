                                                     ...
                                                     json_build_object(
                                                         ...
                                                         'Badges', (
                                                            SELECT json_agg(
                                                             ...
                                                             LEFT JOIN "Badges" pbb ON pbb."BadgeKey"=pb."BadgeKey"
                                                             LEFT JOIN "BadgesTranslations" pbt ON pbt."BadgeKey"=pb."BadgeKey" 
                                                             WHERE mil."MenuItemKey" = pb."ProductKey" AND pb."IsActive" = true AND pbt."LanguageKey" = pt."LanguageKey"
                                                         )
                                                     )
