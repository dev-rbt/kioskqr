...
export function CartSheet({ children, className }: CartSheetProps) {
  ...
  return (
    <Sheet>
      ...
      <SheetContent className="flex flex-col h-full w-full sm:max-w-lg z-[60] bg-gradient-to-br from-background via-background/98 to-background/95 border-l-0 shadow-2xl">
